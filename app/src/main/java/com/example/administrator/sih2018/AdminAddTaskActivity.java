...
public class AdminAddTaskActivity extends AppCompatActivity {
    ...
    public void uploadAssignment(){
        ...
        if((!mGeo_lat.getEditText().getText().toString().equals(null)|| !mGeo_lat.getEditText().getText().toString().equals("")) && (!mGeo_long.getEditText().getText().toString().equals(null)|| !mGeo_long.getEditText().getText().toString().equals(""))){
