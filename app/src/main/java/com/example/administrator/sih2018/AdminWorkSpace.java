...
public class AdminWorkSpace extends AppCompatActivity {
    ...
    public ArrayList<String>  emailadd;
                        ...
                        builder.setNegativeButton("Mail",
                                new DialogInterface.OnClickListener()
                                {
                                    public void onClick(DialogInterface dialog, int id)
                                    {
                                        ...
                                        "mailto",emailadd.get(position) , null));
                                        dialog.dismiss();
...
//                        });
                        ...
                        builder.setNeutralButton("AddTask", new DialogInterface.OnClickListener() {
