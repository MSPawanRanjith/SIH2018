        ...
        if (encrypted != null) {
          ...
          //  v.setVisibility(View.VISIBLE);
           // v.setText(Base64.encodeToString(encrypted, 0 /* flags */));
            String mType =getIntent().getStringExtra("TYPE_OF_LOGIN");
            if(mType.equals("ADMIN")) {
                Intent intent = new Intent(FingerPrintActivity.this, AdminLoginActivity.class);
                startActivity(intent);
            }
            else{
                Intent intent = new Intent(FingerPrintActivity.this, VerifierLoginActivity.class);
                startActivity(intent);
            }
        }
    }
